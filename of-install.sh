...
echo "Installing PHP..."
apt install -y php libapache2-mod-php php-mysql php-bcmath php-json php-mbstring php-tokenizer php-xml
...
echo "Please set the database password in the .env file"
